(this["webpackJsonpfe.lite-mstore-boss"] = this["webpackJsonpfe.lite-mstore-boss"] || []).push([[2],{

/***/ "./node_modules/@mtfe/design-qrcode/dist/browser.js":
/*!**********************************************************!*\
  !*** ./node_modules/@mtfe/design-qrcode/dist/browser.js ***!
  \**********************************************************/
...
var QRCodeMaker = function () {
  function QRCodeMaker(options) {
  ...
  QRCodeMaker.prototype.generate = function () {
    return __awaiter(this, void 0, void 0, function () {
      var _a, content, width, background, comment, dataUrl, qrcodeImageElement, qrcodeImageData, bg, bgImageData, i, j, text;

      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _a = this.options, content = _a.content, width = _a.width, background = _a.background, comment = _a.comment;
            return [4, QRCode.toDataURL(content, this.options)];

          case 1:
            dataUrl = _b.sent();
            return [4, this.createImageElement({
              image: dataUrl,
              width: width,
              height: width
            })];
          ...
          case 2:
            qrcodeImageElement = _b.sent();
            return [4, this.createImageData(qrcodeImageElement, {
              x: 0,
              y: 0,
              width: width,
              height: width
          ...
          case 3:
            qrcodeImageData = _b.sent();
            if (!background) return [3, 5];
            bg = Object.assign({}, defaultBackgroundOptions, typeof background === 'string' ? {
              image: background
            } : background);
            return [4, this.createImageData(bg, {
              x: bg.x,
              y: bg.y,
          ...
          case 4:
            ...
            for (i = 0; i < bgImageData.data.length; i += 4) {
              for (j = 0; j < 3; ++j) {
                bgImageData.data[i + j] = bgImageData.data[i + j] | qrcodeImageData.data[i + j];
              }
            }
          ...
          case 5:
            if (comment) {
              text = Object.assign({}, defaultExplainOptions, typeof comment === 'string' ? {
                text: comment
              } : comment);
              this.fillText(text);
            }
  ...
  QRCodeMaker.prototype.createImageElement = function (options) {
    return new Promise(function (resolve, reject) {
      if (options.image instanceof HTMLImageElement) {
        resolve(options.image);
      } else {
        var element_1 = new Image();

        if (!options.image.startsWith('data:image')) {
          element_1.crossOrigin = 'anonymous';
        }

        element_1.src = options.image;

        if (options.width) {
          element_1.width = options.width;
        }

        if (options.height) {
          element_1.height = options.height;
        }

        element_1.onload = function () {
          return resolve(element_1);
        };
  ...
  QRCodeMaker.prototype.createImageData = function (image, options, canvas) {
    return __awaiter(this, void 0, void 0, function () {
      var element, _a, width, height, context;

      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (!(image instanceof HTMLImageElement)) return [3, 1];
            _a = image;
            return [3, 3];

          case 1:
            return [4, this.createImageElement(image)];
          ...
          case 3:
            element = _a;
            width = image.width || element.width;
            height = image.height || element.height;
            ...
            return [2, context.getImageData(options.x || 0, options.y || 0, options.width || width, options.height || height)];
        }
      });
    });
  };

  QRCodeMaker.prototype.putImageData = function (imageData, x, y) {
  ...
  QRCodeMaker.prototype.fillText = function (options) {
    var context = this.canvas.getContext('2d');
  ...
  QRCodeMaker.prototype.toDataURL = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!!this.generated) return [3, 2];
            return [4, this.generate()];
          ...
          case 2:
            return [2, this.canvas.toDataURL(this.options.type, this.options.quality)];
        }
      });
    });
  };

  QRCodeMaker.prototype.toImage = function () {
    return __awaiter(this, void 0, void 0, function () {
      var dataUrl, img;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4, this.toDataURL()];
  ...
  QRCodeMaker.prototype.toCanvas = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
...
exports.QRCodeMaker = QRCodeMaker;
...
function toDataURL(options) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4, new QRCodeMaker(options).toDataURL()];
...
function toImage(options) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4, new QRCodeMaker(options).toImage()];
...
function toCanvas(options) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4, new QRCodeMaker(options).toCanvas()];
