...
@inject('MusicList')
@observer
class MyMusicContent extends React.Component<IProps, IState> {
  state: IState = {
  ...
  componentWillReceiveProps = async (newProps: any) => {
    let playListId = newProps.playListId;
    const res = await (await getPlayList({ id: +playListId })).data;
    const comment = await (await getCommentList({ id: +playListId })).data;
    this.setState({
      playListId,
  ...
  render() {
    ...
    return <div className="play-list-detail-content clear">
      <div className="music-info clear">
        ...
        <div className="info">
          <div className="content">
            ...
            {playListDetail.description ? <p className="intr clear">
              <b>介绍：</b>
...
export default withRouter(MyMusicContent);